...
RUN set -ex && \
    ...
    apt-get install -y vim netcat net-tools procps bsdmainutils --no-install-recommends --ignore-missing && \
    apt-get install -y git-all --no-install-recommends --ignore-missing && \
